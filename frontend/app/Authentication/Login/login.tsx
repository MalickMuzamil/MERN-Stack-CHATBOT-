                        ...
                        <div className="p-6 pt-0">
                            <form onSubmit={handleSubmit}>
                                ...
                                <div className="mt-4 flex items-center justify-end gap-x-2">
                                    <Link to="/signup" className="inline-flex items-center justify-center rounded-md text-sm font-medium  hover:ring hover:ring-white transition duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 h-10 px-4 py-2 duration-200 hover:bg-[#f86009] hover:text-white">Register</Link>
                                    <button
