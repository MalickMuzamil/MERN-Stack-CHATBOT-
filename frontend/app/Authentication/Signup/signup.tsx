                    ...
                    <div className="p-6 pt-0">
                        <form onSubmit={handleSubmit}>
                            ...
                            <div className="mt-4 flex items-center justify-end gap-x-2">
                                <Link to="/" className="inline-flex items-center justify-center rounded-md text-sm font-medium transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 hover:bg-accent h-10 px-4 py-2 duration-200 hover:bg-white hover:text-black cursor-pointer">Log in</Link>
                                <button
